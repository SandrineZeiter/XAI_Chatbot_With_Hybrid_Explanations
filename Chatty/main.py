...
def webhook():
    ...
    if action == 'information':
        ...
        if start == 'bot_command':
            answer = 'Hi {}, I am Chatty {} Thank you for participating in this experiment. We will talk daily ' \
            ...
            if id_counter_dictionary[chat_id] == 1:
                text = 'Hi {}, I hope you had a great day!{} Could you please share how your day at work went and ' \
            ...
            # Creating the analysis and the feedback
                ...
                text = "Thank you {} for sharing {} I will now quickly analyze what you've told me and provide you " \
                       "with feedback in just a moment.".format(chat_name, emoji)
                send_message(chat_id, text)
                create_file(chat_id, text, userinput)
                ...
                # Using LIME for the predictions and explanations
                ...
                if sorted_category_proba[0][1] - sorted_category_proba[1][1] < 0.05:
                    unsure_answer = "Upon reviewing your feedback on today's workday, I noticed that I rated two " \
                                    "feelings very similarly: {} with {}% and {} with {}%. However, I only " \
                                    "provided an explanation for the first feeling." \
                ...
                # Building np.arrays for positive and negative words
                ...
                answer = answer_comparison + "\n\nThe words in favor of my choice for your feeling being {} " \
                                             "are: \"{}\"." \
                    .format(prediction.upper(), '", " '.join(str(word) for word in positive_words).upper())
                ...
                if negative_idx.size > 0:
                    if negative_idx.size == 1:
                        ...
                        answer += ' \nThe words that would rather indicate a different feeling are: \"{}\".'. \
                            format('", "'.join(str(word) for word in negative_words).upper())
                ...
                # Sending the plot
                with open(figure_name, 'rb') as f:
                    file_contents = f.read()
                requests.post(
                    f'https://api.telegram.org/bot{telegram_token}/sendPhoto',
                    data={'chat_id': chat_id},
                    files={'photo': ('figure.png', file_contents)}
                )
